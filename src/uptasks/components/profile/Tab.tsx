...
const tabs = [
    { name: 'Mi Cuenta', href: `/${PrivateRoutes.PRIVATE}/${PrivateRoutes.PROFILE}`, icon: UserIcon },
    { name: 'Cambiar Contraseña', href: `/${PrivateRoutes.PRIVATE}/${PrivateRoutes.UPDATE_PASSWORD}`, icon: FingerPrintIcon },
]
